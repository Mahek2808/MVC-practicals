...
namespace Practical_09.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController()
        {
            ...
            {
                    new Employee{Id=1,Ename="keshav" , Eage=21 },
                    new Employee{Id=2,Ename="Rina" , Eage=20 },
                    new Employee{Id=3,Ename="pinal" , Eage=29 },
            };
        }
        // GET: Home
        ...
        {
            return Content("<b>Hello</b>,/n World! this message is from Employee Controller using the Action Result, <script> alert('Hi! This is Practical-9') </script>");
        }
